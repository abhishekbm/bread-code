...
public class PlatformFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        this.getActivity().setTitle("Platforms");
        // Inflate the layout for this fragment
        View rootView = inflater.inflate(R.layout.fragment_platform, container, false);
        ListView view = (ListView) rootView.findViewById(R.id.platformList);
        Bundle bundle = this.getArguments();
        String platform_1 = bundle.getString("platform_1");
        String platform_2 = bundle.getString("platform_2");
        ArrayAdapter<String> adapter1 = new ArrayAdapter<String>(this.getContext(), R.layout.support_simple_spinner_dropdown_item);
        adapter1.add(platform_1);
        adapter1.add(platform_2);
